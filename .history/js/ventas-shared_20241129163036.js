...
function validarEstructura() {
    ...
    try {
        actualKit = eval(actualKitInput.value); // Convertir a arreglo
        ...
        alert("El ActualKit debe ser un arreglo válido.");
        return;
    }

    // Validar Datos Cliente (debe ser un arreglo)
    try {
        datosCliente = eval(datosClienteInput.value); // Convertir a arreglo
        ...
        alert("Los Datos del Cliente deben ser un arreglo válido.");
        return;
    }
